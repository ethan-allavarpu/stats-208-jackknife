...
def clean_crime_data(in_data: str, in_names: str, out_path: str) -> tuple:
    ...
    # Categorical columns
    cat_cols = [col for col, col_type in zip(crime.columns, crime.dtypes) if col_type not in (int, float) and col not in drop_cols]
    drop_cols += cat_cols
...
if __name__ == "__main__":
    ...
    crime_dim = clean_crime_data(args.crime_data_path, args.crime_docs_path, args.crime_out_path)
